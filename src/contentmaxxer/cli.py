...
from .manim_scene import manim_available
...
def build_parser() -> argparse.ArgumentParser:
    ...
    director.add_argument(
        "--voice-provider",
        choices=("auto", "none", "say", "elevenlabs", "qwen3", "chatterbox", "file"),
        default="auto",
        help="narration backend; auto prefers ElevenLabs, local Qwen3/MLX, Chatterbox, then macOS say",
    )
    director.add_argument("--voice", default="", help="provider voice name or ElevenLabs voice ID")
    director.add_argument("--voice-rate", type=int, default=170, help="spoken words per minute for local narration")
    director.add_argument(
        "--voice-instruction",
        default="",
